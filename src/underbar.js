(function() {
  ...
  _.filter = function(collection, test) {
    ...
    _.each(collection, function (value, key, collection) { 
       if (test(value, key, collection)) result.push(value);
    });
    return result;
  };
  ...
  _.reject = function(collection, test) {
    ...
    return _.filter(collection, function(value, key, collection) {return !test(value, key, collection);});
  };

  // Produce a duplicate-free version of the array.
  _.uniq = function(array) {
    return _.filter(array, function(value, key, collection) {
      return _.indexOf(collection.slice(0, key), value) === -1 ? true : false;
    });
  };
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(passed, item) {
      return iterator(item) && passed ? true : false;
    }, true);
  };
  ...
  _.some = function(collection, iterator) {
    ...
    if (iterator === undefined) {iterator = _.identity;}
    return _.reduce(collection, function(passed, item) {
      return passed || iterator(item) ? true : false;
    }, false);
  };
  ...
  _.shuffle = function(array) {
    ...
    for (var i = newArray.length - 1; i > 0; i--) {
      var k = Math.floor(Math.random(0, i));
      var tmp = newArray[i];
  ...
  _.invoke = function(collection, functionOrKey, args) {
    if (typeof functionOrKey === "string") {
      _.each(collection, function (value, key, collection) {
        collection[key] = value[functionOrKey].apply(value, args);
      });
    } else {
      _.each(collection, function (value, key, collection) {
        collection[key] = functionOrKey.apply(value, args);
      });
    }
    return collection;
  };
  ...
  _.zip = function() {
    ...
    var results = [];
    var maxLength = _.reduce(args, function(maxLength, item){
  ...
  _.flatten = function(nestedArray, result) {
    ...
    _.each(nestedArray, function (value, key, collection){
  ...
  _.intersection = function() {
    var args = Array.prototype.slice.call(arguments);
    return _.filter(args[0], function(value, key, collection){
      var pass = true;
      for (var i = 1; i < args.length; i++) {
        if (_.indexOf(args[i], value) === -1) { pass = false; }
      }
      return pass;
    });
  };
